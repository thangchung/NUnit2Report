...
-->
  ...
  <xsl:template name="pageHeader">
    ...
    <table width="100%">
      <tr>
        <td align="left">
          <span id=":i18n:GeneratedBy">Generated for </span>Vitcon : <xsl:value-of select="/testsummary/test-results/@date"/> - <xsl:value-of select="concat(/testsummary/test-results/@time,' ')"/> <a href="#" onclick="javascript:Toggle('blabla')" id=":i18n:EnvironmentInformation">Environment Information</a>
        </td>
        <td align="right">
          <span id=":i18n:Designed">Designed for use with</span><a href='http://nunit.sourceforge.net/'>NUnit</a> <span id=":i18n:and">and</span> <a href='http://nant.sourceforge.net/'>NAnt</a>.
        </td>
      </tr>
    </table>
    <hr size="1"/>
