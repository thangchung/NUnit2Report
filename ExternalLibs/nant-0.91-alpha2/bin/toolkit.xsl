...
-->
  <xsl:template name="header">
    ...
    <table width="100%">
      <tr>
        <td align="left">
          <span id=":i18n:GeneratedBy">Generated by</span> Vitcon : <xsl:value-of select="@date"/> - <xsl:value-of select="concat(@time,' ')"/> <a href="#envinfo" id=":i18n:EnvironmentInformation">Environment Information</a>
        </td>
        <td align="right">
