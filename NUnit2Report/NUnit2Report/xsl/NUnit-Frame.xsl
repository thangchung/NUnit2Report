...
-->
  ...
  <xsl:template name="pageHeader">
    ...
    <table width="100%">
      <tr>
        <td align="left">
          <span id=":i18n:GeneratedBy">Generated by</span>Vitcon : <xsl:value-of select="/testsummary/test-results/@date"/> - <xsl:value-of select="concat(/testsummary/test-results/@time,' ')"/> <a href="#" onclick="javascript:Toggle('blabla')" id=":i18n:EnvironmentInformation">Environment Information</a>
        </td>
        <td align="right">
